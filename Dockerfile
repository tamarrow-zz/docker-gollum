...
RUN git clone https://1f449b3cc23d820b61d7d87e59a1c9ea03eb2f0f:x-oauth-basic@github.com/tamarrow/docker-gollum.git docker-gollum
RUN /bin/bash -lc 'cd docker-gollum'
